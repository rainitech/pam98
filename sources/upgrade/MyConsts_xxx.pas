...
const
  ...
  MenoCopyright='Copyright 1996-2008 Pro26 Software House';
...
SMyAppNaozajSpustitGfkGarancne=
  'Nepouívajte túto funkciu bez písomného súhlasu od spoloènosti PRO26 Software House !!!. eláte si spusti nastavenie garanèného poistenia pre všetkıch zamestnancov ?';
...
SMyAppSpustitVypocetCDM=
  'eláte si vypoèíta èistú dennú mzdu pre rok %d ?'+#10#13+
  'Pozor! Budú zmenené karty všetkıch zamestnancov !'+#10#13+
  'Pokraèova ?';
