...
{Precitaj konfiguraciu}
  ...
  if (ZdanObdMes1 <> ZdanObdMes2) or (ZdanObdMes1 = '') then
    begin MyError('Chyba: Element "hlavicka/zdanovacieObdobie/mesiac" nie je rovnak˝ v obidvoch s˙boroch, s˙bory nie je moûnÈ zl˙Ëiù.');exit; end;
  if (ZdanObdRok1 <> ZdanObdRok2) or (ZdanObdRok1 = '') then
    begin MyError('Chyba: Element "hlavicka/zdanovacieObdobie/rok" nie je rovnak˝ v obidvoch s˙boroch, s˙bory nie je moûnÈ zl˙Ëiù.');exit; end;
  if (Dic1 <> Dic2) or (Dic1 = '') then
    begin MyError('Chyba: Element "hlavicka/dic" nie je rovnak˝ v obidvoch s˙boroch, s˙bory nie je moûnÈ zl˙Ëiù.');exit; end;
