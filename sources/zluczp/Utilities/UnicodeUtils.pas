...
type
  ...
  TStrToUTF16ConvFunc = function(const S: string): WideString;
  TUTF16ToStrConvFunc = function(const S: WideString): string;
...
function GetStrToUTF16ConvFunc(Encoding: TdomEncodingType): TStrToUTF16ConvFunc;
function GetUTF16ToStrConvFunc(Encoding: TdomEncodingType): TUTF16ToStrConvFunc;
...
const
  ...
  MapCharToUTF16: array [etUS_ASCII..etWindows_1258] of TCharToUTF16ConvFunc =
  ( US_ASCIIToUTF16Char,
  ...
  MapStrToUTF16: array [etUS_ASCII..etWindows_1258] of TStrToUTF16ConvFunc =
  ( US_ASCIIToUTF16Str,
    Iso8859_1ToUTF16Str,
    Iso8859_2ToUTF16Str,
    Iso8859_3ToUTF16Str,
  ...
  MapUTF16ToChar: array [etUS_ASCII..etWindows_1258] of TUTF16ToCharConvFunc =
  ( UTF16ToUS_ASCIIChar,
  ...
  MapUTF16ToStr: array [etUS_ASCII..etWindows_1258] of TUTF16ToStrConvFunc =
  ( UTF16ToUS_ASCIIStr,
    UTF16ToIso8859_1Str,
    UTF16ToIso8859_2Str,
    UTF16ToIso8859_3Str,
...
function GetCharToUTF16ConvFunc(Encoding: TdomEncodingType): TCharToUTF16ConvFunc;
begin
  if (Encoding >= etUS_ASCII) and (Encoding <= etWindows_1258) then
    Result := MapCharToUTF16[Encoding]
  else
    Result := nil;
end;
...
begin
  if (Encoding >= etUS_ASCII) and (Encoding <= etWindows_1258) then
    Result := MapUTF16ToChar[Encoding]
  else
    Result := nil;
end;
...
begin
  case GetACP of
    874: Result := etCp874;
    932, 936, 949, 950: raise EConvertError.Create('Not supported.');
...
const
  MapEncodingToStr: array[etUTF_8..etWindows_1258] of string =
  ( 'UTF-8',
    'UTF-16BE',
    'UTF-16LE',
    'ISO-10646-UCS-2',
    ...
    'ISO-8859-8',
    'ISO-8859-9',
    'ISO_8859-10',  // The underscore is specified in the MIB specification
    'ISO-8859-11',
    'ISO-8859-12',
    'ISO-8859-13',
    'KOI8-R',
...
function EncodingToStr(const Encoding: TdomEncodingType): String;
begin
  if (Encoding >= etUTF_8) and (Encoding <= etWindows_1258)
    then Result := MapEncodingToStr[Encoding]
    else raise EConvertError.Create('Invalid encoding.');
end;
...
var
  ...
  I: TdomEncodingType;
begin
  for I := etNextStep to etCp1006 do
    if CompareText(S, MapEncodingToStr[I]) = 0 then begin
      Result := I;
      Exit;
    end;
...
const
  Map_Iso8859_2ToUTF16Char: array[$a1..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_Iso8859_2ToUTF16Char[W]
  end;
end;

const
  Map_Iso8859_3ToUTF16Char: array[$a1..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_Iso8859_3ToUTF16Char[W];
    if Result = #$FFFE then
      raise EConvertError.CreateFmt('Invalid ISO-8859-3 sequence of code point %d',[W]);
  end;
end;

const
  Map_Iso8859_4ToUTF16Char: array[$a1..$ff] of WideChar =
  (
  { $a1: Result := } #$0104,  // LATIN CAPITAL LETTER A WITH OGONEK
...
begin
  case W of
    ...
    Result := Map_Iso8859_4ToUTF16Char[W]
  end;
end;
...
const
  Map_Iso8859_10ToUTF16Char: array[$A1..$FF] of WideChar =
  (
  { $a1: Result := } #$0104,  // LATIN CAPITAL LETTER A WITH OGONEK
...
begin
  case W of
    ...
    Result := Map_Iso8859_10ToUTF16Char[W]
  end;
end;

const
  Map_Iso8859_13ToUTF16Char: array[$a1..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_Iso8859_13ToUTF16Char[W]
  end;
end;

const
  Map_Iso8859_14ToUTF16Char: array[$a1..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_Iso8859_14ToUTF16Char[W]
  end;
end;

const
  Map_Iso8859_15ToUTF16Char: array[$a4..$be] of WideChar =
  (
...
function Iso8859_15ToUTF16Char(const W: word):WideChar;
begin
  if (W >= $a4) and (W <= $be) then
    Result := Map_Iso8859_15ToUTF16Char[W]
  else
    Result := WideChar(W);
end;

const
  Map_KOI8_RToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_KOI8_RToUTF16Char[W]
  end;
end;
...
const
  Map_NextStepToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_NextStepToUTF16Char[W]
  end;
end;

const
  Map_cp10000_MacRomanToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_cp10000_MacRomanToUTF16Char[W];
    if Result = #$FFFE then
      raise EConvertError.CreateFmt('Invalid cp10000_MacRoman sequence of code point %d',[W]);
  end;
end;

const
  Map_cp10006_MacGreekToUTF16Char: array[$80..$FF] of WideChar =
  (
  { $80: Result := } #$00C4,  // LATIN CAPITAL LETTER A WITH DIAERESIS
...
begin
  case W of
    ...
    Result := Map_cp10006_MacGreekToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp10007_MacCyrillicToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_cp10007_MacCyrillicToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp10029_MacLatin2ToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00C4,  // LATIN CAPITAL LETTER A WITH DIAERESIS
...
begin
  case W of
    ...
    Result := Map_cp10029_MacLatin2ToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp10079_MacIcelandicToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00C4,  // LATIN CAPITAL LETTER A WITH DIAERESIS
  { $81: Result := } #$00C5,  // LATIN CAPITAL LETTER A WITH RING ABOVE
  { $82: Result := } #$00C7,  // LATIN CAPITAL LETTER C WITH CEDILLA
...
begin
  case W of
    ...
    Result := Map_cp10079_MacIcelandicToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp10081_MacTurkishToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00C4,  // LATIN CAPITAL LETTER A WITH DIAERESIS
  { $81: Result := } #$00C5,  // LATIN CAPITAL LETTER A WITH RING ABOVE
  { $82: Result := } #$00C7,  // LATIN CAPITAL LETTER C WITH CEDILLA
...
begin
  case W of
    ...
    Result := Map_cp10081_MacTurkishToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp037ToUTF16Char: array[$00..$ff] of WideChar =
  (
                     #$0000,
                     #$0001,
                     #$0002,
...
function cp037ToUTF16Char(const W: word): WideChar;
begin
  Result := Map_cp037ToUTF16Char[W];
end;

const
  Map_cp424ToUTF16Char: array[$00..$ff] of WideChar =
  (
                     #$0000,
                     #$0001,
                     #$0002,
...
function cp424ToUTF16Char(const W: word): WideChar;
begin
  Result := Map_cp424ToUTF16Char[W];
  if Result = #$FFFE then
    raise EConvertError.CreateFmt('Invalid cp424 sequence of code point %d',[W]);
end;

const
  Map_cp437ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
...
begin
  case W of
    ...
    case W of
      $00..$7e: Result := WideChar(W);
    else
      Result := Map_cp437ToUTF16Char[W];
//      if Result = #$FFFE then
...
const
  Map_cp437_DOSLatinUSToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp437_DOSLatinUSToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp500ToUTF16Char: array[$00..$ff] of WideChar =
  (
                     #$0000,
                     #$0001,
                     #$0002,
...
function cp500ToUTF16Char(const W: word): WideChar;
begin
  Result := Map_cp500ToUTF16Char[W];
//  if Result = #$FFFE then
//    raise EConvertError.CreateFmt('Invalid cp500 sequence of code point %d',[W]);
end;

const
  Map_cp737_DOSGreekToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_cp737_DOSGreekToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp775_DOSBaltRimToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_cp775_DOSBaltRimToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp850ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp850_DOSLatin1ToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp850_DOSLatin1ToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp852ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp852_DOSLatin2ToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp852_DOSLatin2ToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp855ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
...
const
  Map_cp855_DOSCyrillicToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$0452,  // CYRILLIC SMALL LETTER DJE
  { $81: Result := } #$0402,  // CYRILLIC CAPITAL LETTER DJE
  { $82: Result := } #$0453,  // CYRILLIC SMALL LETTER GJE
...
begin
  case W of
    ...
    Result := Map_cp855_DOSCyrillicToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp856_Hebrew_PCToUTF16Char: array[$80..$ff] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_cp856_Hebrew_PCToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp857ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp857_DOSTurkishToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp857_DOSTurkishToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp860ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp860_DOSPortugueseToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp860_DOSPortugueseToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp861ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp861_DOSIceLandicToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp861_DOSIcelandicToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp862ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$05d0,  // HEBREW LETTER ALEF
  { $81: Result := } #$05d1,  // HEBREW LETTER BET
...
const
  Map_cp862_DOSHebrewToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$05d0,  // HEBREW LETTER ALEF
  { $81: Result := } #$05d1,  // HEBREW LETTER BET
  { $82: Result := } #$05d2,  // HEBREW LETTER GIMEL
...
begin
  case W of
    ...
    Result := Map_cp862_DOSHebrewToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp863ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp863_DOSCanadaFToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp863_DOSCanadaFToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp864ToUTF16Char: array[$7f..$FF] of WideChar =
  (
  { $7f: Result := } #$001a,
...
const
  Map_cp864_DOSArabicToUTF16Char: array[$80..$FF] of WideChar =
  (
  { $80: Result := } #$00b0,  // DEGREE SIGN
  { $81: Result := } #$00b7,  // MIDDLE DOT
  { $82: Result := } #$2219,  // BULLET OPERATOR
...
begin
  case W of
    ...
    case W of
      ...
      Result := Map_cp864_DOSArabicToUTF16Char[W];
      if Result = #$FFFE then
...
const
  Map_cp865ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
...
const
  Map_cp865_DOSNordicToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$00c7,  // LATIN CAPITAL LETTER C WITH CEDILLA
  { $81: Result := } #$00fc,  // LATIN SMALL LETTER U WITH DIAERESIS
  { $82: Result := } #$00e9,  // LATIN SMALL LETTER E WITH ACUTE
...
begin
  case W of
    ...
    Result := Map_cp865_DOSNordicToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp866ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
  { $80: Result := } #$0410,  // CYRILLIC CAPITAL LETTER A
  { $81: Result := } #$0411,  // CYRILLIC CAPITAL LETTER BE
...
const
  Map_cp866_DOSCyrillicRussianToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$0410,  // CYRILLIC CAPITAL LETTER A
  { $81: Result := } #$0411,  // CYRILLIC CAPITAL LETTER BE
  { $82: Result := } #$0412,  // CYRILLIC CAPITAL LETTER VE
...
begin
  case W of
    ...
    Result := Map_cp866_DOSCyrillicRussianToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp869ToUTF16Char: array[$7f..$ff] of WideChar =
  (
  { $7f: Result := } #$001a,
                     #$FFFE,
                     #$FFFE,
...
const
  Map_cp869_DOSGreek2ToUTF16Char: array[$80..$ff] of WideChar =
  (
                     #$FFFE,
                     #$FFFE,
                     #$FFFE,
...
begin
  case W of
    ...
    Result := Map_cp869_DOSGreek2ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp874ToUTF16Char: array[$80..$ff] of WideChar =
  (
...
const
  Map_cp875ToUTF16Char: array[$00..$ff] of WideChar =
  (
                     #$0000,
                     #$0001,
                     #$0002,
...
begin
  case W of
    $00..$A0: Result:= WideChar(W);
  else
    Result := Map_cp1006ToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp1026ToUTF16Char: array[$00..$ff] of WideChar =
  (
                     #$0000,
                     #$0001,
                     #$0002,
...
function cp1026ToUTF16Char(const W: word): WideChar;
begin
  Result := Map_cp1026ToUTF16Char[W];
//  if Result = #$FFFE then
//    raise EConvertError.CreateFmt('Invalid cp1026 sequence of code point %d',[W]);
end;

const
  Map_cp1250ToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$20ac,  // EURO SIGN
                     #$FFFE,
...
begin
  case W of
    ...
    // NOT USED:  $81,$83,$88,$90,$98:
    Result := Map_cp1250ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp1251ToUTF16Char: array[$80..$bf] of WideChar =
  (
...
begin
  case W of
    ...
    Result := Map_cp1251ToUTF16Char[W];
    if Result = #$FFFE then
      raise EConvertError.CreateFmt('Invalid cp1251 sequence of code point %d',[W]);
  end;
end;

const
  Map_cp1252ToUTF16Char: array[$80..$9f] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
                     #$FFFE,
  { $82: Result := } #$201A,  // SINGLE LOW-9 QUOTATION MARK
...
begin
  case W of
    ...
    Result := Map_cp1252ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp1253ToUTF16Char: array[$80..$FF] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
                     #$FFFE,
  { $82: Result := } #$201A,  // SINGLE LOW-9 QUOTATION MARK
...
begin
  case W of
    ...
    Result := Map_cp1253ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp1254ToUTF16Char: array[$80..$FF] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
                     #$FFFE,
  { $82: Result := } #$201A,  // SINGLE LOW-9 QUOTATION MARK
...
begin
  case W of
    ...
    Result := Map_cp1254ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp1255ToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
                     #$FFFE,
  { $82: Result := } #$201A,  // SINGLE LOW-9 QUOTATION MARK
...
begin
  case W of
    ...
    Result := Map_cp1255ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp1256ToUTF16Char: array[$80..$ff] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
...
begin
  case W of
    ...
    Result := Map_cp1256ToUTF16Char[W];
//    if Result = #$FFFE then
...
const
  Map_cp1257ToUTF16Char: array[$80..$FF] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
                     #$FFFE,
  { $82: Result := } #$201A,  // SINGLE LOW-9 QUOTATION MARK
...
begin
  case W of
    ...
    Result := Map_cp1257ToUTF16Char[W];
    if Result = #$FFFE then
...
const
  Map_cp1258ToUTF16Char: array[$80..$FF] of WideChar =
  (
  { $80: Result := } #$20AC,  // EURO SIGN
                     #$FFFE,
  { $82: Result := } #$201A,  // SINGLE LOW-9 QUOTATION MARK
...
begin
  case W of
    ...
    Result := Map_cp1258ToUTF16Char[W];
    if Result = #$FFFE then
