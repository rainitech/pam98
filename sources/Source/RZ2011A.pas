...
type
  TReportRZ_2011 = class(TQuickRep)
    DetailBand1: TQRBand;
    QRLabel32: TQRLabel;
    QRLabel36: TQRLabel;
    QRLabel38: TQRLabel;
    ...
    procedure ReportRZ_2011BeforePrint(Sender: TQuickRep;
...
var
  ReportRZ_2011: TReportRZ_2011;

procedure RunReportRZ_2011(const MyReportParam: TMyReportParam);
procedure RunReport_NEZISK1_2011(const MyReportParam: TMyReportParam);
procedure RunReport_NEZISK2_2011(const MyReportParam: TMyReportParam);
...
procedure TReportRZ_2011.ShowReportStart;
begin
  first_preview:=True;
...
procedure TReportRZ_2011.ShowReportEnd;
begin
  QINF_.Close;
  Q0_.Close;
end;

procedure TReportRZ_2011.Q0_CalcFields(DataSet: TDataSet);
...
procedure RunReportRZ_2011(const MyReportParam: TMyReportParam);
begin with ReportRZ_2011 do begin
  X:=MyReportParam;
  Screen.Cursor:=crHourGlass;
  try
  try
    ReportRZ_2011:=TReportRZ_2011.Create(Application);
    if X.DisableShape then QRDisableShape(ReportRZ_2011);
    if X.DisableLabel then QRDisableLabel(ReportRZ_2011);
    Screen.Cursor:=crDefault;
    ReportRZ_2011.ShowReportStart;
    if Q0_.Active AND (Q0_.RecordCount>0) then ReportRZ_2011.Preview;
    ReportRZ_2011.ShowReportEnd;
...
begin with ReportRZ_2011 do begin
  ...
  try
    ...
    Screen.Cursor:=crDefault;
    ReportRZ_2011.ShowReportStart;
    if ReportRZ_2011.Q0_.Active AND (ReportRZ_2011.Q0_.RecordCount=0) then
    begin
...
procedure TReportRZ_2011.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportRZ_2011.ReportRZ_2011BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
