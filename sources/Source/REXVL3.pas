...
type
  TReportVL3 = class(TQuickRep)
    ...
    QRShape86: TQRShape;
    QRShape87: TQRShape;
    E_N_dohody_ovp: TQRExpr;
    E_N_dohody_opc: TQRExpr;
    QRLabel14: TQRLabel;
    QRLabel25: TQRLabel;
    QRShape88: TQRShape;
    QRShape89: TQRShape;
    ...
    Q1_dan_spolu: TCurrencyField;
    Q1_nd_spolu: TCurrencyField;
    Q1_vy_zaloha: TCurrencyField;
    Q1_vy_hot: TCurrencyField;
    Q1_d_vyrovnanie: TCurrencyField;
    QRLabel70: TQRLabel;
    QRShape136: TQRShape;
    QRShape138: TQRShape;
    E_N_clenovia_organov: TQRExpr;
    ...
    Q1_vy_spor: TCurrencyField;
    Q1_vy_zraz: TCurrencyField;
    ...
    QRShape145: TQRShape;
    QRExpr70: TQRExpr;
    Q0_CALC_BRUTTO_DOHODY: TCurrencyField;
    QRShape99: TQRShape;
    QRLabel57: TQRLabel;
    QRShape114: TQRShape;
    QRExpr79: TQRExpr;
    ...
    QRShape163: TQRShape;
    QRExpr80: TQRExpr;
    Q1_n_brutto_dohody: TCurrencyField;
    QRShape164: TQRShape;
    QRLabel84: TQRLabel;
    QRShape165: TQRShape;
    QRExpr1: TQRExpr;
    ...
    Q0_CALC_DAN_PREPLATOK: TCurrencyField;
    Q0_CALC_DAN_NEDOPLATOK: TCurrencyField;
    QRShape179: TQRShape;
    QRShape131: TQRShape;
    QRLabel87: TQRLabel;
    QRShape184: TQRShape;
    ...
    QRShape185: TQRShape;
    Q2a_: TQuery;
    Q2a_d_nedoplatok: TCurrencyField;
    Q2b_: TQuery;
    Q2b_d_preplatok: TCurrencyField;
    ...
    Q0_f_priplat1_text: TStringField;
    Q0_f_priplat2_text: TStringField;
    Q0_f_priplat3_text: TStringField;
    Q0_f_priplat4_text: TStringField;
    Q0_f_priplat5_text: TStringField;
    QRShape47: TQRShape;
    QRLabel60: TQRLabel;
    QRShape85: TQRShape;
    QRExpr48: TQRExpr;
    ...
    QRShape191: TQRShape;
    QRExpr87: TQRExpr;
    Q0_D_dan_minula: TCurrencyField;
    QRExpr67: TQRExpr;
    QRLabel_zrazkova2: TQRLabel;
    Q3_: TQuery;
    Q3_d_dan: TCurrencyField;
    QRShape36: TQRShape;
    QRShape130: TQRShape;
    QRShape181: TQRShape;
    QRLabel20: TQRLabel;
    ...
    Q1_vreckove: TCurrencyField;
    QRShape194: TQRShape;
    QRShape195: TQRShape;
    QRExpr91: TQRExpr;
    QRLabel67: TQRLabel;
    Q0_Rezerva2: TCurrencyField;
    procedure Q0_CalcFields(DataSet: TDataSet);
    procedure ReportVL3BeforePrint(Sender: TQuickRep;
...
var
  ReportVL3: TReportVL3;

procedure RunReportVL3(const MyReportParam: TMyReportParam);

implementation

{$R *.DFM}

procedure TReportVL3.ShowReport;
begin
  first_preview := true;
  if X.Obdobie1=X.Obdobie2 then
  begin
    QRLabel47.Caption := 'REKAPITULÁCIA MIEZD ZA ' +
      Mesiac(X.Obdobie1 mod 100,true)+' '+IntToStr(X.Obdobie1 div 100);
    QRLabel_zrazkova2.Caption := 'Zrážková daò za minulý mesiac';
  end else
  begin
    QRLabel47.Caption := 'REKAPITULÁCIA MIEZD ZA ROK ' +
      IntToStr(X.Obdobie1 div 100);
    QRLabel_zrazkova2.Caption := 'Pri roènej rekapitulácii : nevyplnené';
  end;
  if X.AktSidList<>'' then begin
   Q3_.SQL.Add(X.AktSidList);
   Q0_.SQL.Add(StrReplaceX(X.AktSidList,'sid','v.sid'));
  end;
  Q3_.Close;
  Q3_.ParamByName('P1').AsInteger := Obdobie_Add_MM(X.Obdobie1,-1);
  Q3_.ParamByName('P2').AsInteger := X.AktMinSid;
  Q3_.ParamByName('P3').AsInteger := X.AktMaxSid;
  Q3_.Open;
  Q0_.Close;
  Q0_.ParamByName('P1').AsInteger := X.Obdobie1;
  Q0_.ParamByName('P1X').AsInteger := X.Obdobie2;
...
procedure TReportVL3.Q0_CalcFields(DataSet: TDataSet);
begin
  if X.Obdobie1=X.Obdobie2 then
  Q0_D_dan_minula.Value := Q3_D_dan.Value
  else
  Q0_D_dan_minula.AsString := '';
  ...
  Q0_CALC_ZRAZKY.Value :=
    Q0_Ne_stravne.Value +
    Q0_Ne_poistovna.Value +
    Q0_Ne_pozicky.Value +
    Q0_Ne_odborar.Value +
    Q0_Ne_exekucia.Value;

  if Q0_Dan_vyrovnana.Value=1
  then Q0_CALC_brutto_dohody.Value:=Q0_N_brutto.Value
  else Q0_CALC_brutto_dohody.Value:=0;

  if Q0_D_VYROVNANIE.Value < 0 then begin
    Q0_CALC_DAN_NEDOPLATOK.Value := ABS(Q0_D_VYROVNANIE.Value);
    Q0_CALC_DAN_PREPLATOK.Value  := 0;
  end else begin
    Q0_CALC_DAN_NEDOPLATOK.Value := 0;
    Q0_CALC_DAN_PREPLATOK.Value  := ABS(Q0_D_VYROVNANIE.Value);
  end;
end;

procedure TReportVL3.SetX(const MyReportParam:TMyReportParam);
begin
  X:=MyReportParam;
end;
...
begin
  ...
  try
    ...
    ReportVL3.SetX(MyReportParam);
    if ReportVL3.X.DisableShape then QRDisableShape(ReportVL3);
    if ReportVL3.X.DisableLabel then QRDisableLabel(ReportVL3);
    Screen.Cursor:=crDefault;
    ReportVL3.ShowReport;
...
procedure TReportVL3.ReportVL3BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
