...
type
  TReportPZ2007 = class(TQuickRep)
    ...
    procedure ReportPZ2007BeforePrint(Sender: TQuickRep;
...
var
  ReportPZ2007: TReportPZ2007;

  procedure RunReportPZ2007(const MyReportParam: TMyReportParam);
...
procedure TReportPZ2007.ShowReport;
begin
  try
  first_preview:=true;
...
procedure TReportPZ2007.Q0_CalcFields(DataSet: TDataSet);
var i,j:byte;
...
begin
  ...
  try
  try
    ReportPZ2007:=TReportPZ2007.Create(Application);
    if X.DisableShape then QRDisableShape(ReportPZ2007);
    if X.DisableLabel then QRDisableLabel(ReportPZ2007);
    Screen.Cursor:=crDefault;
    ReportPZ2007.ShowReport;
...
procedure TReportPZ2007.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2007.ReportPZ2007BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TReportPZ2007.Q00_CalcFields(DataSet: TDataSet);
begin
