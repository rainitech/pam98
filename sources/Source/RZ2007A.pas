...
type
  TReportRZ_2007 = class(TQuickRep)
    DetailBand1: TQRBand;
    QRLabel32: TQRLabel;
    QRLabel36: TQRLabel;
    QRLabel38: TQRLabel;
    ...
    procedure ReportRZ_2007BeforePrint(Sender: TQuickRep;
...
var
  ReportRZ_2007: TReportRZ_2007;

procedure RunReportRZ_2007(const MyReportParam: TMyReportParam);
procedure RunReport_NEZISK1_2007(const MyReportParam: TMyReportParam);
procedure RunReport_NEZISK2_2007(const MyReportParam: TMyReportParam);
...
procedure TReportRZ_2007.ShowReportStart;
begin
  first_preview:=True;
...
procedure TReportRZ_2007.ShowReportEnd;
begin
  QINF_.Close;
  Q0_.Close;
end;

procedure TReportRZ_2007.Q0_CalcFields(DataSet: TDataSet);
...
procedure RunReportRZ_2007(const MyReportParam: TMyReportParam);
begin with ReportRZ_2007 do begin
  X:=MyReportParam;
  Screen.Cursor:=crHourGlass;
  try
  try
    ReportRZ_2007:=TReportRZ_2007.Create(Application);
    if X.DisableShape then QRDisableShape(ReportRZ_2007);
    if X.DisableLabel then QRDisableLabel(ReportRZ_2007);
    Screen.Cursor:=crDefault;
    ReportRZ_2007.ShowReportStart;
    if Q0_.Active AND (Q0_.RecordCount>0) then ReportRZ_2007.Preview;
    ReportRZ_2007.ShowReportEnd;
...
begin with ReportRZ_2007 do begin
  ...
  try
    ...
    Screen.Cursor:=crDefault;
    ReportRZ_2007.ShowReportStart;
    if ReportRZ_2007.Q0_.Active AND (ReportRZ_2007.Q0_.RecordCount=0) then
    begin
...
procedure TReportRZ_2007.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportRZ_2007.ReportRZ_2007BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
