...
type
  TReportRZ_2014B = class(TQuickRep)
    Q0_: TQuery;
    Q0_ADR: TStringField;
    Q0_TMP: TStringField;
    ...
    procedure ReportRZ_2014BBeforePrint(Sender: TQuickRep;
...
var
  ReportRZ_2014B: TReportRZ_2014B;

procedure RunReportRZ_2014B(const MyReportParam: TMyReportParam);
...
procedure TReportRZ_2014B.ShowReport;
begin
  first_preview := true;
  ...
  Q0_.Open;
  QINF_.Open;
  if Q0_.Active AND (Q0_.RecordCount>0) then ReportRZ_2014B.Preview;
  QINF_.Close;
  Q0_.Close;
end;

procedure TReportRZ_2014B.Q0_CalcFields(DataSet: TDataSet);
...
begin
  ...
  try
  try
    ReportRZ_2014B:=TReportRZ_2014B.Create(Application);
    if X.DisableShape then QRDisableShape(ReportRZ_2014B);
    if X.DisableLabel then QRDisableLabel(ReportRZ_2014B);
    Screen.Cursor:=crDefault;
    ReportRZ_2014B.ShowReport;
...
procedure TReportRZ_2014B.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportRZ_2014B.ReportRZ_2014BBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
