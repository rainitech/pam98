...
type
  TReportPZ2009 = class(TQuickRep)
    ...
    QRLabel74: TQRLabel;
    QDDP2008_: TQuery;
    QDDP2008_code_emp: TIntegerField;
    QDDP2008_n_ddp: TCurrencyField;
    QRLabel84: TQRLabel;
    QRLabel86: TQRLabel;
    QRLabel87: TQRLabel;
    QRLabel88: TQRLabel;
    ...
    procedure ReportPZ2009BeforePrint(Sender: TQuickRep;
...
var
  ReportPZ2009: TReportPZ2009;

  procedure RunReportPZ2009(const MyReportParam: TMyReportParam);
...
procedure TReportPZ2009.ShowReport;
begin
  try
  first_preview:=true;
...
procedure TReportPZ2009.Q0_CalcFields(DataSet: TDataSet);
var i,j,pp99,dh99:byte;
    bonus_dieta,bonus_vypocet,bonus_check,ddp: double;
...
begin
  ...
  try
  try
    ReportPZ2009:=TReportPZ2009.Create(Application);
    if X.DisableShape then QRDisableShape(ReportPZ2009);
    if X.DisableLabel then QRDisableLabel(ReportPZ2009);
    Screen.Cursor:=crDefault;
    ReportPZ2009.ShowReport;
...
procedure TReportPZ2009.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2009.ReportPZ2009BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TReportPZ2009.Q00_CalcFields(DataSet: TDataSet);
begin
