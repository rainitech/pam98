...
type
  TReportPZ2008 = class(TQuickRep)
    ...
    QRLabel76: TQRLabel;
    QRShape71: TQRShape;
    QRLabelMena2: TQRLabel;
    QRLabelMena1: TQRLabel;
    QRLabelMena4: TQRLabel;
    QRLabelMena5: TQRLabel;
    ...
    QRLabelMena3: TQRLabel;
    QRLabel56: TQRLabel;
    QRLabel61: TQRLabel;
    QRLabel63: TQRLabel;
    QRLabel35: TQRLabel;
    QRLabelMena6: TQRLabel;
    QRShape22: TQRShape;
    QRShape37: TQRShape;
    QRShape39: TQRShape;
    QRLabel64: TQRLabel;
    ...
    procedure ReportPZ2008BeforePrint(Sender: TQuickRep;
...
var
  ReportPZ2008: TReportPZ2008;

  procedure RunReportPZ2008(const MyReportParam: TMyReportParam);
...
procedure TReportPZ2008.ShowReport;
begin
  try
  first_preview:=true;
  ...
  if X.AktObdobie >= ZAKON_2009_01 then begin
    QRLabelMena1.Caption := '(v €)';
    QRLabelMena2.Caption := '(v €)';
    QRLabelMena3.Caption := '(v €)';
    QRLabelMena4.Caption := '(v €)';
    QRLabelMena5.Caption := '(v €)';
    QRLabelMena6.Caption := '(v €)';
    QRMemo1.Lines[3]     := 'V riadkoch 06 a 07 sa uvedie èíselné oznaèenie mesiacov a úhrnná suma v €.';
    QRDBText1.Mask := '0.00';
    QRDBText2.Mask := '0.00';
...
procedure TReportPZ2008.Q0_CalcFields(DataSet: TDataSet);
var i,j:byte;
    bonus_dieta,bonus_vypocet,bonus_check: double;
    mesiace_vypocet,numfrm: string;
...
begin
  ...
  then Q0_CALC_DDP.Value := Trim(X.Nc_ine2)
    ...
    then Q0_CALC_DDP.Value := Format(numfrm,[QDDP_n_ddp.Value])
...
begin
  ...
  try
  try
    ReportPZ2008:=TReportPZ2008.Create(Application);
    if X.DisableShape then QRDisableShape(ReportPZ2008);
    if X.DisableLabel then QRDisableLabel(ReportPZ2008);
    Screen.Cursor:=crDefault;
    ReportPZ2008.ShowReport;
...
procedure TReportPZ2008.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2008.ReportPZ2008BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TReportPZ2008.Q00_CalcFields(DataSet: TDataSet);
begin
