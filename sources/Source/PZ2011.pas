...
type
  TReportPZ2011 = class(TQuickRep)
    ...
    procedure ReportPZ2011BeforePrint(Sender: TQuickRep;
...
var
  ReportPZ2011: TReportPZ2011;

  procedure RunReportPZ2011(const MyReportParam: TMyReportParam);
...
procedure TReportPZ2011.ShowReport;
var SL: TStringList;
begin
  try
  first_preview:=true;
...
procedure TReportPZ2011.Q0_CalcFields(DataSet: TDataSet);
...
begin
  ...
  try
  try
    ReportPZ2011:=TReportPZ2011.Create(Application);
    if X.DisableShape then QRDisableShape(ReportPZ2011);
    if X.DisableLabel then QRDisableLabel(ReportPZ2011);
    Screen.Cursor:=crDefault;
    ReportPZ2011.ShowReport;
...
procedure TReportPZ2011.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2011.ReportPZ2011BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
 progress_page := 0;
...
procedure TReportPZ2011.Q00_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2011.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
