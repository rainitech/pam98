...
type
  TReportRZ_2011B = class(TQuickRep)
    Q0_: TQuery;
    Q0_ADR: TStringField;
    Q0_TMP: TStringField;
    ...
    procedure ReportRZ_2011BBeforePrint(Sender: TQuickRep;
...
var
  ReportRZ_2011B: TReportRZ_2011B;

procedure RunReportRZ_2011B(const MyReportParam: TMyReportParam);
...
procedure TReportRZ_2011B.ShowReport;
begin
  first_preview := true;
  ...
  Q0_.Open;
  QINF_.Open;
  if Q0_.Active AND (Q0_.RecordCount>0) then ReportRZ_2011B.Preview;
  QINF_.Close;
  Q0_.Close;
end;

procedure TReportRZ_2011B.Q0_CalcFields(DataSet: TDataSet);
...
begin
  ...
  try
  try
    ReportRZ_2011B:=TReportRZ_2011B.Create(Application);
    if X.DisableShape then QRDisableShape(ReportRZ_2011B);
    if X.DisableLabel then QRDisableLabel(ReportRZ_2011B);
    Screen.Cursor:=crDefault;
    ReportRZ_2011B.ShowReport;
...
procedure TReportRZ_2011B.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportRZ_2011B.ReportRZ_2011BBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
