...
type
  TReportRZ_2005B = class(TQuickRep)
    DetailBand1: TQRBand;
    QRShape38: TQRShape;
    QRShape4: TQRShape;
    QRShape14: TQRShape;
...
var
  ReportRZ_2005B: TReportRZ_2005B;

procedure RunReportRZ_2005B(const MyReportParam: TMyReportParam);
...
procedure TReportRZ_2005B.ShowReport;
begin
  ...
  Q0_.Open;
  QINF_.Open;
  if Q0_.Active AND (Q0_.RecordCount>0) then ReportRZ_2005B.Preview;
  QINF_.Close;
  Q0_.Close;
end;

procedure TReportRZ_2005B.Q0_CalcFields(DataSet: TDataSet);
...
begin
  ...
  try
  try
    ReportRZ_2005B:=TReportRZ_2005B.Create(Application);
    if X.DisableShape then QRDisableShape(ReportRZ_2005B);
    if X.DisableLabel then QRDisableLabel(ReportRZ_2005B);
    Screen.Cursor:=crDefault;
    ReportRZ_2005B.ShowReport;
...
procedure TReportRZ_2005B.QINF_CalcFields(DataSet: TDataSet);
begin
