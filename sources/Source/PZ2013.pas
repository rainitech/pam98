...
type
  TReportPZ2013 = class(TQuickRep)
    ...
    procedure ReportPZ2013BeforePrint(Sender: TQuickRep;
...
var
  ReportPZ2013: TReportPZ2013;

  procedure RunReportPZ2013(const MyReportParam: TMyReportParam);
...
procedure TReportPZ2013.ShowReport;
var SL: TStringList;
  s: string;
begin
  {try}
...
procedure TReportPZ2013.Q0_CalcFields(DataSet: TDataSet);
...
begin
  ...
  try
  try
    ReportPZ2013:=TReportPZ2013.Create(Application);
    if X.DisableShape then QRDisableShape(ReportPZ2013);
    if X.DisableLabel then QRDisableLabel(ReportPZ2013);
    Screen.Cursor:=crDefault;
    ReportPZ2013.ShowReport;
...
procedure TReportPZ2013.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2013.ReportPZ2013BeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
 progress_page := 0;
...
procedure TReportPZ2013.Q00_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportPZ2013.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  progress_page := progress_page + 1;
