...
type
  TReportRZ_2012B = class(TQuickRep)
    Q0_: TQuery;
    Q0_ADR: TStringField;
    Q0_TMP: TStringField;
    ...
    procedure ReportRZ_2012BBeforePrint(Sender: TQuickRep;
...
var
  ReportRZ_2012B: TReportRZ_2012B;

procedure RunReportRZ_2012B(const MyReportParam: TMyReportParam);
...
procedure TReportRZ_2012B.ShowReport;
begin
  first_preview := true;
  ...
  Q0_.Open;
  QINF_.Open;
  if Q0_.Active AND (Q0_.RecordCount>0) then ReportRZ_2012B.Preview;
  QINF_.Close;
  Q0_.Close;
end;

procedure TReportRZ_2012B.Q0_CalcFields(DataSet: TDataSet);
...
begin
  ...
  try
  try
    ReportRZ_2012B:=TReportRZ_2012B.Create(Application);
    if X.DisableShape then QRDisableShape(ReportRZ_2012B);
    if X.DisableLabel then QRDisableLabel(ReportRZ_2012B);
    Screen.Cursor:=crDefault;
    ReportRZ_2012B.ShowReport;
...
procedure TReportRZ_2012B.QINF_CalcFields(DataSet: TDataSet);
begin
...
procedure TReportRZ_2012B.ReportRZ_2012BBeforePrint(Sender: TQuickRep;
  var PrintReport: Boolean);
begin
